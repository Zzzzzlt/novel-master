    ...
    const renderContent = () => (
        ...
        >
            ...
            <div className="absolute bottom-6 right-6 flex flex-col gap-2 z-50 pointer-events-auto">
                 <Button size="icon" variant="secondary" className="bg-cyan-900/50 text-cyan-400 hover:bg-cyan-800 border-cyan-800" title={t('rightPanel.autoArrange')} onClick={handleAutoArrange}><Wand2 size={18}/></Button>
